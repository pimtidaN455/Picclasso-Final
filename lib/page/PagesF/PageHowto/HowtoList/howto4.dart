...
class HowToUse4 extends StatefulWidget {
  //const HowToUse2({Key? key}) : super(key: key);
  String pagehow;
  HowToUse4({required this.pagehow});
  @override
  Howto4 createState() => Howto4(pagehowto: pagehow);
}

class Howto4 extends State<HowToUse4> {
  @override
  String pagehowto;
  Howto4({required this.pagehowto});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          'วิธีเปลี่ยนชื่อผู้ใช้และรหัสผ่าน',
          style: TextStyle(
            fontSize: 20,
