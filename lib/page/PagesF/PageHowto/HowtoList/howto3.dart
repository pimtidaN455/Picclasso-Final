                                ...
                                children: [
                                  Row(
                                    ...
                                    children: <Widget>[
                                      Flexible(
                                        child: Text(
                                          'ถ้าคุณต้องการฝากรูปไว้พร้อมกับคัดแยกรูปภาพทำได้โดย อัพโหลดรูปภาพที่หน้าคลาวด์',
                                          style: TextStyle(
                                            fontSize: 16,
                                  ...
                                  Row(
                                    ...
                                    children: <Widget>[
                                      Flexible(
                                        child: Text(
                                          'เมื่ออัพโหลดเสร็จสิ้นรูปภาพจะถูกนำไปรวมในหน้าอัลบั้มบั้มต่างๆ\n\nถ้าต้องการลบรูปสามารถกดไอคอนถังขยะ\n\nถ้าต้องการดาวน์โหลดให้กดไอคอนดาวน์โหลด',
                                          style: TextStyle(
                                            fontSize: 16,
                                            color: MyStyle().blackColor,
                                            fontFamily: 'Rajdhani',
