...
class AlertDialogs_downloads_cloud {
            ...
            TextButton(
              ...
              onPressed: () async {
                ...
                for (int i = 0; i < img.length; ++i) {
                  print(img[i].imageURL);
                  print(img[i].tokenphoto);
                  final tempDir = await getTemporaryDirectory();
                  final path = '${tempDir.path}/' + img[i].tokenphoto + '.jpg';
                  await Dio().download(img[i].imageURL, path);
